...
'''
    ...
    def test_brigade_help(self):
        ...
        result = subprocess.run(['./brigade', '--help'], 
    ...
    def test_analyze_command_help(self):
        ...
        result = subprocess.run(['./brigade', 'analyze', '--help'], 
                              capture_output=True, text=True, cwd='.')
    ...
    def test_auto_fix_command_help(self):
        ...
        result = subprocess.run(['./brigade', 'auto-fix', '--help'], 
                              capture_output=True, text=True, cwd='.')
    ...
    def test_approve_command_help(self):
        ...
        result = subprocess.run(['./brigade', 'approve', '--help'], 
                              capture_output=True, text=True, cwd='.')
    ...
    def test_analyze_nonexistent_file(self):
        ...
        result = subprocess.run(['./brigade', 'analyze', 'nonexistent.py'], 
                              capture_output=True, text=True, cwd='.')
    ...
    def test_analyze_with_test_file(self):
        ...
        result = subprocess.run(['./brigade', 'analyze', 'test_code.py'], 
                              capture_output=True, text=True, cwd='.')
        
        # Should work even without AWS credentials (will show error but not crash)
        assert 'Target: test_code.py' in result.stdout or 'error' in result.stdout.lower()
    
    def test_approve_list_empty(self):
        """Test listing approvals when none exist"""
        result = subprocess.run(['./brigade', 'approve', '--list'], 
                              capture_output=True, text=True, cwd='.')
    ...
    def test_dry_run_with_test_file(self):
        ...
        result = subprocess.run(['./brigade', 'auto-fix', 'test_code.py', '--dry-run'], 
                              capture_output=True, text=True, cwd='.')
    ...
    def test_invalid_command(self):
        ...
        result = subprocess.run(['./brigade', 'invalid-command'], 
                              capture_output=True, text=True, cwd='.')
